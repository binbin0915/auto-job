...
public interface IAutoJobRegister {
    ...
    boolean registerTask(AutoJobTask task, long waitTime, TimeUnit unit);
     ...
     * @date 2022/7/4 12:51
     */
    boolean removeTask(AutoJobTask remove);
    ...
    AutoJobTask removeAndGetTask(long taskId);

    AutoJobTask getTaskById(long taskId);
