package com.example.autojob.skeleton.framework.network.client;

import com.example.autojob.skeleton.framework.network.enums.ReqType;
import com.example.autojob.skeleton.framework.network.handler.client.ConnectTimeoutException;
import com.example.autojob.skeleton.framework.network.handler.client.ConnectionClosedException;
import com.example.autojob.skeleton.framework.network.handler.client.ResponseTimeoutException;
