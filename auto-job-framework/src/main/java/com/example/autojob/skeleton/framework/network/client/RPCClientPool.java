...
public class RPCClientPool extends GenericObjectPool<RPCClient> {
    ...
    private RPCClientPool(Bootstrap bootstrap, GenericObjectPoolConfig<RPCClient> config, long connectTimeout, long getDataTimeout, TimeUnit unit) {
    ...
    public static class Builder {
        ...
        public RPCClientPool build() {
            ...
            config.setMaxWait(Duration.ofMillis(getClientTimeout));
            config.setSoftMinEvictableIdleTime(Duration.ofMillis(keepAliveTime));
