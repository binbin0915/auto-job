package com.example.autojob.util.json;
...
public class JsonUtil {
    ...
    private static Gson getGson() {
        return new GsonBuilder().enableComplexMapKeySerialization().setDateFormat("yyyy-MM-dd HH:mm:ss").registerTypeAdapter(Class.class, new ClassCodec()).create();
    }
